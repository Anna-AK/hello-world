...
<p>   Закончила он-лайн курс SkillFactory <b>"Тестировщик-автоматизатор на Python"</b>. Я многое могу, по ссылкам ниже можно посмотреть мои учебные работы на <b>Python</b>, использую <b>Selenium</b> и <b>PageObject</b>, "поднимаю" <b>SQL</b>, представляю принципы работы <b>Jira</b>, пользуюсь <b>Postman</b>, в том числе для тестирования <b>REST API</b>. 
